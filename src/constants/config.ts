export const CONFIG = {
  ...
  language: 'Coyotes Players', // This changes the display name for your language
  ...
  wordListSource: 'Coyotes Players', // Describe the source material for your words here
